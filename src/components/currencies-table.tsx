...
export function CurrenciesTable({ data, selectedDate }: CurrenciesTableProps) {
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-muted-foreground">
                        Fonte: {currency.source || 'n/a'}
                      </div>
                    </div>
                  </div>
                </TableCell>
                <TableCell className="text-right font-mono">
                  <AnimatedNumber value={currency.price} currency={currency.currency} />
                </TableCell>
